...
if __name__ == "__main__":
    try:
        answer = invoke_chain("can you tell me the price of the iPhone 14?")
        print("\n Assistant Answer:\n", answer)
        ...
        # cd /Users/nanimahi/E-commerce-Product-Assistant
        # python -m product_assistant.workflow.normal_generation_workflow